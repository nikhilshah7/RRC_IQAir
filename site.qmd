...
* **Map** will show you all the data from the community air monitors on a map over the last year.
...
* **Terms** contains an explanation of any terms and acronyms that you might find unfamiliar.
...
| **Term** | **Explanation** |
| --- | --- |
| AQI | \"Air Quality Index\". A measure of pollutants in the air, including particulates, ozone, nitrogen oxides, and more. |
| PM2.5 | Particulate matter less than 2.5 microns. Usually emitted from vehicles and factories. |
