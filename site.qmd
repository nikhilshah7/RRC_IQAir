        ...
        navset_card_tab(
          ...
          nav_panel("Air Quality Over Time",
                    ...
                    layout_sidebar(
                      sidebar = sidebar(
                          sliderInput(
                            "daterange", "Dates:", min = min(data_daily$date), max = max(data_daily$date), value = c(min(data_daily$date), max(data_daily$date)), timeFormat = "%Y-%m-%d"
                            ),
                          dateRangeInput("realdaterange", "Dates:", start = min(data_daily$date), end = max(data_daily$date), min = min(data_daily$date), max = max(data_daily$date)),
