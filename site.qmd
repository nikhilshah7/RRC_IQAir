            ...
            layout_sidebar(
              sidebar = sidebarPanel(
                accordion(
                  ...
                  accordion_panel(
                    "Variables",
                    radioButtons("chosenVariable", "X", available_variables[-5], selected = ""),
                    radioButtons("chosenYVariable", "Y", available_Yvariables, selected = "")
                  ),
                  accordion_panel(
                    "Site 1",
                    radioButtons("chosenSite1", "Site 1:", available_sites, selected = "")
                  ), 
                  accordion_panel(
                    "Site 2",
                    radioButtons("chosenSite2", "Site 2:", available_sites, selected = "")
                  ),
                  accordion_panel(
                    "Timescales",
