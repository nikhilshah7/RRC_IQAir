...
#what is the NA output?? ask Nikhil about look at the original address doc, am I missing a city for about 3 monitors?
...
nrow(all_PA_data)
average_PM25 <- mean(all_PA_data$pm2.5_atm) # very high, some crazy outliers, 67.58
average_PM10 <-mean(all_PA_data$pm10.0_atm) # same, 69.25

summary(all_PA_data$pm2.5_atm) # median is 9
summary(all_PA_data$pm10.0_atm) # median is 10.0
```
